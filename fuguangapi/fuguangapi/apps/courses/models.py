...
class CourseDiretion(BaseModel):
...
class CourseCategory(BaseModel):
    ...
    diretion = models.ForeignKey("CourseDiretion", related_name="category_list", on_delete=models.DO_NOTHING, db_constraint=False, verbose_name="学习方向")
    class Meta:
...
class Course(BaseModel):
    ...
    recomment_home_hot = models.BooleanField(default=False, verbose_name="是否推荐到首页新课栏目")
    recomment_home_top = models.BooleanField(default=False, verbose_name="是否推荐到首页必学栏目")
    diretion = models.ForeignKey("CourseDiretion", related_name="course_list", on_delete=models.DO_NOTHING, null=True, blank=True, db_constraint=False, verbose_name="学习方向")
...
class CourseLesson(BaseModel):
    ...
    lesson_link = models.CharField(max_length=255, blank=True, null=True, help_text="若是video，填视频地址或者，若是文档，填link", verbose_name="课时链接")
    ...
    course = models.ForeignKey("Course", related_name="lesson_list", on_delete=models.CASCADE, db_constraint=False, verbose_name="课程")
    class Meta:
